// In a normal semaphore, the kernel code is optimized for the mostly available case
// In a completion, the semaphore is optimized for the mostly not available case
